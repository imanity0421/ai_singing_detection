...
const GRADE_CONFIG: Record<
  string,
  {
    /** Gradient start colour for the disc */
    from: string
    /** Gradient end colour for the disc */
    to: string
    /** Soft shadow / glow colour */
    glow: string
    subtitle: string
    cheer: string
  }
> = {
  ...
  A: {
    from: "#D8A030",
    to: "#F0CC60",
    glow: "rgba(216,160,48,0.18)",
    subtitle: "出色发挥",
    cheer: "表现得真好，越唱越有味道！",
  },
}

// Score floor = 80, guaranteeing every user at least an S
    ...
    >
      {!showResult || !evaluation ? null : (
        <>
          ...
          {/* ---- Score Hero ---- */}
          <div className="flex flex-col items-center px-6 pt-12 pb-5">
            {/* Single clean gradient disc */}
            <div className="relative">
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: `0 10px 32px -4px ${grade.glow}, inset 0 1px 1px rgba(255,255,255,0.30)`,
                }}
              >
                <span
            ...
            <div className="mt-5 flex items-baseline gap-1">
              <span className="text-7xl font-black text-foreground leading-none">{animatedScore}</span>
